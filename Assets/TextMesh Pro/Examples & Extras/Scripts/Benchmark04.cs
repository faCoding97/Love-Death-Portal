        ...
        void Start()
        {
            ...
            for (int i = MinPointSize; i <= MaxPointSize; i += Steps)
            {
                if (SpawnType == 0)
                {
                    ...
                    //TextMeshProBase.fontSharedMaterial = material;
                    //TextMeshProBase.font = Resources.Load("Fonts & Materials/LiberationSans SDF", typeof(TextMeshProFont)) as TextMeshProFont;
                    //TextMeshProBase.anchor = AnchorPositions.Left;

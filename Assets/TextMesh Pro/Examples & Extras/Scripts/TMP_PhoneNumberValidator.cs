...
namespace TMPro
{
    ...
    /// </summary>
    [Serializable]
    //[CreateAssetMenu(fileName = "InputValidator - Phone Numbers.asset", menuName = "TextMeshProBase/Input Validators/Phone Numbers")]
    public class TMP_PhoneNumberValidator : TMP_InputValidator
    {
        ...
        public override char Validate(ref string text, ref int pos, char ch)
        {
            ...
            // DelegateEventChang unless the character is a valid digit
